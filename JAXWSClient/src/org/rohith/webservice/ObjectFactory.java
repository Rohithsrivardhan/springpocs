 ...
 * generated in the org.rohith.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.rohith.org/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.rohith.org/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.rohith.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.rohith.org/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.rohith.org/", name = "helloWorldResponse")
