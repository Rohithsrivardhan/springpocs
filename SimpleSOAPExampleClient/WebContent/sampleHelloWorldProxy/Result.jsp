...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="org.rohith.webservices.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        org.rohith.webservices.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
