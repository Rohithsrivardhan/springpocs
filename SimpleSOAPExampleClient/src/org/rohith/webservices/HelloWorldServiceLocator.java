...
package org.rohith.webservices;

public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.rohith.webservices.HelloWorldService {
    ...
    public org.rohith.webservices.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public org.rohith.webservices.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.rohith.webservices.HelloWorldSoapBindingStub _stub = new org.rohith.webservices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.rohith.webservices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.rohith.webservices.HelloWorldSoapBindingStub _stub = new org.rohith.webservices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.rohith.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.rohith.org", "HelloWorld"));
        }
